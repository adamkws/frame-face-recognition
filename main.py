...
def analyze_and_save_faces(parent_dir, analyzer, cfg):
    ...
    analyzed_dir = os.path.join(parent_dir, 'analyzed')
    ...
    for frame_file in os.listdir(parent_dir):
        frame_path = os.path.join(parent_dir, frame_file)
    ...
    print(f"Analysis completed. Results and faces saved in: {analyzed_dir}")
